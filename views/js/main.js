...
var resizePizzas = function(size) {
  ...
  */
  ...
  function changePizzaSizes(elemArray, newwidth) {
  ...
  //calculate the newwidth once for all elements
  var dx = determineDx(pcArray[0], size);
  var newwidth = (pcArray[0].offsetWidth + dx) + 'px';

  //changing the size of pizzaContainers
  changePizzaSizes(pcArray,newwidth);
